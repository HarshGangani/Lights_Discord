...
import { ActionTooltip } from "../navigation/action-toolkit";
        ...
        <div className="relative group flex items-center hover:bg-black/5 p-4 transition w-full">
            <div className="group flex gap-x-2 items-start w-full">
                ...
                <div className="flex flex-col w-full">
                    ...
                    {!fileUrl && !isEditing && (
                        <p className={cn(`text-xs text-zinc-600 dark:text-zinc-300", 
                            deleted ? "italic  dark:text-zinc-400 `)}>
                            {content}
                            {isUpdated && !deleted && (
                                            ...
                                            <FormControl>
                                                <Input
                                                    className="p-2 bg-zinc-200/90 dark:bg-zinc-700/75 border-none border-0 focus-visible:ring-0 
                                                        focus-visible:ring-offset-0 text-zinc-900 dark:text-zinc-100"
                        ...
                        {canEditMessage && (
                            <ActionTooltip label="Edit">
                                <Edit
                                    ...
                                    className="cursor-pointer ml-auto w-4 h-4 text-zinc-500 dark:text-zinc-600 hover:text-zinc-600 dark:hover:text-zinc-300 transition"
                                />
                            </ActionTooltip>
                        )}
