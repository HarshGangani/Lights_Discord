    ...
    return (
        <>
            <button
                ...
                <p
                    className="font-semibold text-sm text-zinc-500 dark:text-zinc-300
                ...
                <kbd className="pointer-events-none inline-flex h-5 select-none items-center gap-1 rounded border
                    bg-muted px-1.5 font-mono text-[10px] font-medium leading-tight text-muted-foreground ml-auto">
